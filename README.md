...
1. **Set up a retail sales database**: Create and populate a sql_project_p1 database with the provided sales data.
...
SELECT COUNT(DISTINCT customer_id) FROM[sql_project_p1].[dbo].[retail sales];
SELECT DISTINCT category FROM [sql_project_p1].[dbo].[retail sales]s;
...
This project is part of my portfolio, showcasing the SQL skills essential for analytcs  . 
